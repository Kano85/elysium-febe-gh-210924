...
const images = [
  { src: '/images/image-5.png', width: 400, height: 225 },
  { src: '/images/image-6.png', width: 400, height: 225 },
  { src: '/images/image-7.png', width: 400, height: 225 },
];
...
export default function Marquee() {
  ...
  return (
    <div
      className="relative flex flex-col gap-8 overflow-hidden p-12 sm:p-6"
      id="next-section"
    >
      {/* First Marquee Row */}
        ...
        {[...images, ...images, ...images, ...images].map((img, i) => (
          ...
          >
            <Image
              ...
              width={img.width}
              height={img.height}
              className="rounded-md w-[250px] md:w-[350px] aspect-video object-cover transition-transform duration-300 hover:scale-[1.02]"
              priority={i < 4}
            />
          </div>
        ))}
